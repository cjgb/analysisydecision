...
![Image of excel table dynamic 1](/images/2013/11/agrupar_excel_tabla_dinamica_1.png)
...
![Image of excel table dynamic 2](/images/2013/11/agrupar_excel_tabla_dinamica_2.png)

Es un campo más de nuestra tabla dinámica y podemos utilizarlo a nuestro antojo. Si, por el contrario, deseamos agrupar una variable numérica en tramos de un determinado tamaño, no seleccionamos campos, pero con el botón derecho seleccionamos **Agrupar** y obtendremos el siguiente cuadro de diálogo:

![Image of excel table dynamic 3](/images/2013/11/agrupar_excel_tabla_dinamica_3.png)

En este caso empezamos en el valor mínimo y vamos al máximo; en tramos de 5 en 5 obtendremos lo siguiente:

![Image of excel table dynamic 4](/images/2013/11/agrupar_excel_tabla_dinamica_4.png)
