...
1. **ERROR: THE FORMAT $NAME WAS NOT FOUND OR COULD NOT BE LOADED**
   Llamamos a un formato que no existe, muy habitual en input o put.
1. **NOTE: THE MEANING OF AN IDENTIFIER AFTER A QUOTED STRING MAY CHANGE IN A FUTURE SAS RELEASE. INSERTING WHITE SPACE BETWEEN A QUOTED STRING AND THE SUCCEEDING IDENTIFIER IS RECOMMENDED.**
   Esto no pasa…
1. **NOTE: INVALID ARGUMENT TO FUNCTION INPUT AT LINE N COLUMN N**
...
1. **NOTE: SAS WENT TO A NEW LINE WHEN INPUT STATEMENT REACHED PAST THE END OF A LINE**
...
1. **NOTE: INVALID DATA FOR VARIABLE-NAME AT LINE N**
...
1. **WARNING: THE QUOTED STRING CURRENTLY BEING PROCESSED HAS BECOME MORE THAN 262 CHARACTERS LONG. YOU MAY HAVE UNBALANCED QUOTATION MARKS.**
   Otro problema poco habitual, seguid haciendo caso a Kim.
1. **WARNING: MULTIPLE LENGTHS WERE SPECIFIED FOR THE VARAIBLE VARIABLE-NAME BY INPUT DATA SET(S). THIS MAY CAUSE TRUNCATION OF DATA.**
