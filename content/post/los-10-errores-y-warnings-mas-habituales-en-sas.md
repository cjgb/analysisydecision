...
8. **`NOTE: INVALID DATA FOR VARIABLE-NAME AT LINE N`**
   Si definimos una variable de un tipo no podemos emplear datos de otro tipo, es decir, si la variable es numérica no la igualéis a un carácter y viceversa. Tenedlo en cuenta.
