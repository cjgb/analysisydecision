...
![Voronoi Python 1](/images/2017/12/voronoi_python1.png)

Estos puntos aleatorios en el espacio de 2 dimensiones pueden generar regiones por interpolación y representarlas con `voronoi_plot_2d`:
...
![Voronoi Python 2](/images/2017/12/voronoi_python2.png)

Ahora, si queremos determinar si un punto del espacio está dentro de una de las celdas que delimitan los diagramas de `Voronoi` que hemos creado, podemos hacerlo por vecinos cercanos con la función `cKDTree`:
