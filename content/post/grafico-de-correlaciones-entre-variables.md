...
La clave es `geom_tile`, que nos permite pintar mapas que estarán compuestos de cuadrados y representarán el coeficiente de correlación entre las variables. Con `scale_fill_continuous` especificamos el rango de colores y el número de grupos que utilizamos; como vemos, es el objeto `escala` el que nos indica el número de grupos. Por último, añadimos un título y tenemos un gráfico de correlaciones tan bonito como el que tenemos arriba.