...
- preposiciones.
- conjunciones.
- artículos (solo en algunos casos).
- fechas.
...
Pero habremos de introducirlo en un bucle que recorra nuestro diccionario de palabras irrelevantes. Es decir, hemos de limpiar la tabla de datos palabra por palabra. Las palabras estarán en otra hoja de `Excel` que denominaremos «diccionario». Con todo esto, nuestro proceso queda:

```vba
Sub Limpieza()
  ' Rutina que reemplaza por vacío
  Dim pal As String
  Dim para As Integer, i As Integer, j As Integer
