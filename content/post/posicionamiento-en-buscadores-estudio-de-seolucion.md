...
Para el posicionamiento en buscadores, Seolución plantea distintas palabras clave, las escribe en buscadores y plantea un ranking de empresas en función de la posición en la que aparece la búsqueda. Por ejemplo, para el sector bancario en el estudio de 2008: buscamos *Préstamos Bancarios* y cada banco o caja se posiciona en el ranking en función del orden de la búsqueda. Con esta metodología aparentemente sencilla, crea un ratio de visibilidad por empresa. Muy interesante y práctico.

Por otro lado, el índice de popularidad lo mide en función de los enlaces externos; además, también nos ofrece los resultados del `PageRank`, un número que asigna un nivel de popularidad a una web en función del número recíproco de *links*. Proviene de un algoritmo matemático potente de `Google` que busca medir el impacto de una web en otras. Podéis encontrar amplia documentación al respecto.

Además, en el estudio trabaja con otros indicadores como número de páginas indexadas o el índice `Alexa`.

Desde estas líneas quiero recomendar la lectura de sus informes. La información que ofrecen es muy valiosa y puede permitirnos crear una estrategia para que nuestra organización tenga mayor visibilidad. Saludos.