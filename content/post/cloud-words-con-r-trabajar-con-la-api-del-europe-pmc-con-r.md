...
Una de las delicadezas que nos brinda wordcloud2 es que podéis tener **problemas a la hora de visualizar los resultados** , si esto ocurre en el visor de gráficos arriba a la derecha tenéis un botón que es _show in new window_ , le dais y debería abrirse el navegador, si sigue sin verse nada dad a actualizar y no seáis impacientes, los resultados aparecerán y son mejores.
