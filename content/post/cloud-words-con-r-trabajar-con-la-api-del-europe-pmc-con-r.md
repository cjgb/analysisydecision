...
ggplot(autismo, aes(year, query_hits)) +
  ...
  ylab("Artículos publicados sobre autismo")
```
...
wordcloud(
  words = df$word, freq = df$freq, min.freq = 3,
