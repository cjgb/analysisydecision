...
No se me ocurrió cómo hacer el código más sencillo y, al final, lo que hace es recorrer el `array` de libros que abre y añadir las hojas sobre un libro nuevo. Tiene algunas limitaciones en la forma en la que pega las nuevas hojas, pero nada que pueda ser muy complicado de solucionar. Ahora tenéis que mejorar [la entrada más visitada de este blog](https://analisisydecision.es/trucos-excel-unir-todos-los-excel-en-uno-version-muy-mejorada/) para que pueda unir en uno los `Excel` que se abren. Saludos.