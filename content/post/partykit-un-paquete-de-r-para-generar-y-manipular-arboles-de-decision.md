...
La presentación en sociedad del nuevo paquete va a realizarse en la [conferencia de usuarios de R](http://www2.agrocampus-ouest.fr/math/useR-2009/) y es de esperar que, una vez disponamos de una versión estable del paquete, cambie de manera sustancial la manera en que utilicemos esta familia de modelos tan importante en la práctica.