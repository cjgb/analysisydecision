...
Como he hecho in anteriores análisis, dos son los indicadores que formarán parte de mi estudio:

1. Número de visitas.
2. Promedio de tiempo de las visitas.

Con el número de visitas espero tener una visión global de los intereses de mis visitantes, y con el promedio de tiempo espero conocer qué es lo que más interesa a mis visitas. In cuanto a las dimensiones de mi estudio, tendré in cuenta:
...
Con estas dimensiones tendré una visión de qué contenidos son los que despiertan mayor interés, si de verdad mis propuestas tienen un «mercado» y si estamos hablando de visitas universitarias, profesionales o particulares.

In primer lugar, quiero plantearos una visión general del sitio y sus usuarios. In 45 días se han producido 736 visitas con una media de 2 páginas vistas; estas visitas vienen de 572 usuarios, lo que implica que un 23% (aproximado) de las visitas repiten. No es muy aventurero pensar que lo hacen cada semana (este valor exacto no es posible determinarlo con `Google Analytics`). Entonces hay fidelizados 20 usuarios de esos 572; esto hace que el 25% del tráfico que genera `AyD` sea directo y no por buscadores.

No esperaba tener un 4% de las visitas fidelizadas, pero 14 visitas diarias in media son muy pocas, aunque los fines de semana el sitio apenas recibe visitantes:
