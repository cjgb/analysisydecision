...
- [bank-additional-full.csv](/images/2019/04/bank-additional-full.csv)
- [index.csv](/images/2019/04/index.csv)
...
In este caso la vida es maravillosa y ha salido todo a la primera, pero sabemos que eso no pasa siempre; ejecutáis:
...
Este último truco puede servir para leer `CSV` extremadamente grandes y realizar los primeros análisis aproximativos a nuestro problema porque, como dice un buen amigo, «si in 200.000 registros no encuentras una señal, no hace falta que cargues millones». Saludos.
