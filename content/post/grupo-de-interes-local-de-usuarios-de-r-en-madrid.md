...
[http://r-es.org/Grupo+de+Inter%C3%A9s+Local+de+Madrid+-+GIL+Madrid](http://r-es.org/Grupo+de+Inter%C3%A9s+Local+de+Madrid+-+GIL+Madrid)

Ahora ya dispone de su propia `URL`:

[http://madrid.r-es.org/](http://madrid.r-es.org/)

En ella podéis encontrar todos los datos de interés sobre el grupo de usuarios de `R`. El miércoles nos vemos.
