...
Todo el contenido estará dispuesto en un [repositorio de Git](https://github.com/analisisydecision/Estadistica-data-scientist) y se irá publicando de forma paralela en mi blog [Análisis y Decisión](https://analisisydecision.es/).
...
- [Introduction to Statistical Learning](https://fcorowe.github.io/sl/)
...
Los aspectos teóricos están sacados del [material que publica José R. Berrendero](https://caminosaleatorios.wordpress.com/materiales-docentes/) y se recomienda seguir [todo su trabajo en la web](http://matematicas.uam.es/~joser.berrendero/docencia.html).
