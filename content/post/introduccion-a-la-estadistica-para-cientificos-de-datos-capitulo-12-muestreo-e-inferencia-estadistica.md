...
```r
no_interesados <- nrow(train[trainResponse==0,])
interesados <- nrow(train[trainResponse==1,])
...
Hay infinidad de contrastes de hipótesis, en el [este link](https://bookdown.org/aquintela/EBE/contrastes-de-hipotesis.html) quedan recogidos una gran parte y fundamentalmente como se clasifican:
