...
Nos hemos descargado tres banderas y las hemos guardado como objetos de R. Ahora hemos de pintar un podio:

```r
# Pintamos el podio
plot(c(1, 1), c(1, 2), type = "l", xlim = c(0, 5), ylim = c(0, 5),
     lwd = 2, col = "red", axes = FALSE, xlab = " ", ylab = " ")
...
¿Imposible? Seguramente, pero todavía hay esperanza. Saludos.