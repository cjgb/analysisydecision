...
![Happy_con_R](/images/2017/03/Happy_con_R.png)

Gráfico absurdo con `R` y un buen ejemplo de las cosas que hace $\pi$. Tras 2 meses de dolores intensos en mi hombro, hoy solo noto una molestia y, claro…

```r
plot(rep(10, 10), rep(10, 10), ann = FALSE, type = "n", xlim = c(-1, 1), ylim = c(-1, 1), axes = FALSE)
radio <- 1
