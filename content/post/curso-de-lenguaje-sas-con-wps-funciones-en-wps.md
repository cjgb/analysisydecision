...
- `COMPRESS`: Elimina caracteres específicos (o todos los espacios por defecto).
- `COUNT`: Cuenta el número de veces que aparece una cadena.
- `INDEX`: Busca una cadena de caracteres y devuelve su posición.
...
- `SCAN`: Extrae una palabra de una cadena.
- `SUBSTR`: Extrae partes de una cadena.
- `TRANWRD`: Reemplaza cadenas de caracteres.
- `TRIMN`: Elimina espacios en blanco finales.
