...
ccaatasa_COVID <- (ccaacasos/ccaahabitantes)*1000
...
```r
rectangulo <- data.frame(xmin=min(ccaa2long)-0.2, xmax=max(ccaa2long)+0.1,
                         ymin=min(ccaa2lat)-0.1, ymax=max(ccaa2lat)+0.1)
...
[![](/images/2020/04/coronavirus20.png)](/images/2020/04/coronavirus20.png)
