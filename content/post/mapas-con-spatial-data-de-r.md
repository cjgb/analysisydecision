...
![colombia13.jpg](/images/2010/10/colombia13.jpg "colombia13.jpg")
...
Cada uno de los `.Rdata` descargados nos ofrece varios mapas; podemos elegir cuál es el que más se adecúa al análisis que vamos a realizar:
...
A modo de ilustración, vamos a representar el PIB per cápita de las provincias españolas. Ahora voy a trabajar con España porque conozco muy bien su división territorial, pero el ejemplo lo podréis extrapolar a México y Colombia. Voy a representar el PIB per cápita por provincia. Los datos que he sacado del INE los meto manualmente y en orden por provincia:
