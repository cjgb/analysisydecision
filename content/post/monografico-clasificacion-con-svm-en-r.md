...
predic <- predict(modelo, muestra)
table(muestra$grupo, predic)
```
...
[![svm-clasificacion-r.JPG](/images/2010/06/svm-clasificacion-r.JPG)](/images/2010/06/svm-clasificacion-r.JPG)

Espero que despierte vuestra curiosidad con esta técnica y, para aquellos que la conocen, comentadnos qué paquete de R empleáis o qué software recomendáis. Por otro lado, si alguien ha comparado las SVM con las redes neuronales que nos lo cuente, porque son técnicas con muchas similitudes pero con una ventaja clara para las SVM: la **facilidad de comprensión**.
