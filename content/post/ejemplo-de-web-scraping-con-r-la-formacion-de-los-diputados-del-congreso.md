...
1. Lo ponemos todo en un `data frame` por si queremos `analizarlo`.
...
No he trabajado mucho con ello, pero podemos buscar la `palabra` que más se repite [replicando algún código ya conocido](https://analisisydecision.es/analisis-del-programa-electoral-de-pp-y-psoe-con-r/):
