...
Si la distancia al centro es menor o igual a 1, está dentro del primer cuadrante de la circunferencia:
...
# Vamos a añadir una línea con la circunferencia
x_seq = seq(0, 1, by = 0.05)
y_seq = sqrt(1 - x_seq^2)
circunferencia = data.frame(cbind(x_seq, y_seq))
