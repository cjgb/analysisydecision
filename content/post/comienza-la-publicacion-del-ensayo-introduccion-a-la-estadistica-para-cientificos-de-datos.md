...
En Twitter ya hice mención a la creación de un libro/ensayo de introducción a la `Estadística para científicos de datos con R`. Me preocupaba cómo compartir el libro y cómo podría ser útil a alguien que se está introduciendo en la ciencia de datos.
...
[**Estadística para Científicos de Datos**](https://analisisydecision.es/estadistica-data-scientist/index.html)
...
Cada capítulo tendrá su correspondiente entrada en el blog, pero tened en cuenta que lo más actualizado siempre será Git y el propio libro; es posible que haya una modificación y que ésta tarde en ser puesta en el blog. En este sentido, sí agradeceré los comentarios que vayáis poniendo en el blog.
