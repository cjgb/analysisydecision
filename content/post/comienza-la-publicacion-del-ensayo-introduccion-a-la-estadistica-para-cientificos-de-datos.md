...
El libro será un proyecto de RStudio que se sube al directorio de git <https://github.com/rvaquerizo02/Estadistica-data-scientist> clonáis el repositorio, podéis abrir directamente los notebooks desde vuestro RStudio y ejecutar vía knitr-bookdown por lo que os permite crear vuestros propios apuntes y reutilizar de forma sencilla el código que se emplea. En este sentido recordad que el trabajo se publica mediante una licencia **Creative Commons** el libro se puede utilizar libremente pero requiere las correspondientes menciones.
