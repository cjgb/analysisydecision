...
> `cadena1,cadena2,cadena3` en:
> `cadena1`
> `cadena2`
> `cadena3`
>
> Para encontrar la `,` utilizo `scan`, aunque podría ocupar `anypunct` para que encuentre la primera `,`, luego la segunda `,`, etc., y cortar con `substr`, `length`… Pero bueno, ya que tengo un método de separar el texto de la fila, ¿cómo hago para que cada palabra esté en una nueva fila? Ojalá me hayan entendido y me den una idea de cómo hacer eso en un `PROC SQL`, con una `macro` o como sea; ¡solo una pequeña orientación me serviría mucho, gracias!
