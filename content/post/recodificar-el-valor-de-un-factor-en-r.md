...
dt1 <- recode(dt, "0:1='Tipo 1'; 2='Tipo 2'; 3='Tipo 3'; else='Tipo 4'")
...
dt2 <- as.item(dt, labels = c('Tipo 1' = 0, 'Tipo 1' = 1, 'Tipo 2' = 2, 'Tipo 3' = 3,
                             'Tipo 4' = 4, 'Tipo 4' = 5, 'Tipo 4' = 6, 'Tipo 4' = 7, 
                             'Tipo 4' = 8, 'Tipo 4' = 9, 'Tipo 4' = 10))

table(dt2)
summary(dt2)
```

Tras ejecutar el código entenderéis por qué no la uso. Espero que haya respuestas a esta entrada con otras posibilidades o que alguien me justifique el empleo de `as.item`. Saludos.