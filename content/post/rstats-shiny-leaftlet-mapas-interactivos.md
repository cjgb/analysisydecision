...
![Leaflet_shiny](/images/2021/09/Leaflet_shiny.png)
...
Vemos que `puntos` será el conjunto de datos para presentar las coordenadas en el mapa, se creará en el momento en el que modifiquemos el filtro, por ello usamos `eveReactive`, si cambiamos se actualiza el dashboard. Añadimos el código necesario para crear un data frame con el filtrado
