...
Si definimos el formato como `10 - 15`, tendremos números $>10$ y $\le 15$. El intervalo quedará cerrado por la derecha. Si deseamos cerrar el intervalo por la izquierda, tendremos que hacerlo de la forma `10 -< 15` (los espacios son importantes):
...
En este caso, si definimos el formato como `10 -< 15`, se traduce en $\ge 10$ y $< 15$. Programación básica con `SAS` que da respuesta a una duda recurrente. Saludos.
