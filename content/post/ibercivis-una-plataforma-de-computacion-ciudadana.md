...
¿Qué moléculas pueden *pegarse* a una proteína dada? Es una cuestión de laboratorio, de intuición y de prueba y error. ¿Solo? No. Existen otros métodos.
...
Pero ¿y si esta labor se distribuyese entre, digamos, 10.000 ordenadores? Pues… día y medio. Es decir, en día y medio sería posible pasar a un laboratorio una serie de moléculas candidatas para ver si, efectivamente, son capaces o no de interactuar con una proteína dada. Y, posiblemente, crear un fármaco.

¿No creéis que vale la pena castigar un poquito la `CPU` del ordenador con fines similares a este?
