...
Asignamos la librería al archivo `Excel` que deseamos leer y tan simple como referenciar al rango en nuestro paso `data`. Se interactúa fácil entre `Excel` y SAS. Saludos.