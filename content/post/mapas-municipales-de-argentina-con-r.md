...
# Filtramos por los municipios de Buenos Aires
b.aires = argentina[argentina@data$NAME_1 == "Buenos Aires", ]

# Generamos datos aleatorios para pintar el mapa
aleatorio = rpois(length(unique(b.aires@data$NAME_2)), 3)
b.aires@data$aleatorio = aleatorio
spplot(b.aires, "aleatorio", col.regions = brewer.pal(5, "Blues"))
```
