...
Viene acompañado de [una presentación](http://i2pi.com/rez/ml_talk/slides.pdf "Presentación") que parece que casi habla de otra cosa. Fea o bonita, está escrita con [Beamer](http://es.wikipedia.org/wiki/Beamer "Beamer") (para los no iniciados: Beamer es lo que el Ministerio de Trabajo no quisiera nunca que se popularizara: mandaría al paro a esas hordas de [pepeteros](http://office.microsoft.com/en-us/powerpoint/default.aspx "M$ Powerpoint") que pueblan las oficinas menos productivas).
