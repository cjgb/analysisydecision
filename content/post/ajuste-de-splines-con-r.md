...
# Es importante ver la tendencia de los residuos
plot(rep(0, length(puntos)), col = "red", type = "l", ylim = c(-0.5, 0.5))
...
suavizado.datos <- smooth.spline(puntos, w = pesos, spar = 0.75)
plot(puntos)
lines(suavizado.datos$y, col = "red")

plot(rep(0, length(puntos)), col = "red", type = "l")
lines(residuals(suavizado.datos), col = "blue")
```
