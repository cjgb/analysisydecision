...
Poca cosa, poco talento y bastante claro. Pero sí me gustaría destacar el uso de la opción de SAS `-initstmt`, que nos permite ejecutar SAS poniendo un código previamente (*init statement*). Esta opción nos permite pasar una macro como parámetro que es leída en una celda de `Excel`. Es una opción habitual cuando hacemos archivos ejecutables para SAS. Espero que sea de utilidad. Saludos.