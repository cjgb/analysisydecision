...
Interesante el uso de la librería `RColorBrewer`. Particularmente me gusta mucho el resultado que nos da _wordcloud_ para la realización de las nubes de palabras con una sintaxis sencilla. Considero imprescindible el uso de `random.order=FALSE`. Espero que os sea de utilidad.
