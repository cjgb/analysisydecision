...
Nuestro lector José Antonio tiene una [nueva versión del mapa](/images/2011/07/mapa-de-espana-2.xlsm "mapa-de-espana-2.xlsm") de España por provincias con `Excel`. Mejores y más comprensibles macros; el problema de León y las Canarias solventados, y aparecen Ceuta y Melilla.

![Mapa de España en Excel](/images/2011/07/mapa_espana_excelv3.png)
...
Tenéis dos ejemplos de uso y una macro que deja en blanco el mapa. Espero que os sea de utilidad. Por supuesto, **quería agradecer a José Antonio su aportación al blog**. Saludos.