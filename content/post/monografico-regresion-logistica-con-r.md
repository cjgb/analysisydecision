...
$ municipio      : Factor w/ 3323 levels "Abadín","Abadiño",..: 8 11 17 83 174 207 261 282 469 517 ...
$ ine            : int  4001 4002 4003 4006 4011 4013 4016 4017 4024 4029 ...
$ var.pob        : num  23 -25 2176 1018 471 ...
$ var.pob.esp    : num  -57 -72 758 -562 191 625 23 60 670 298 ...
$ var.pob.ext    : num  80 47 1418 1580 280 ...
$ var.pob.03.08  : num  1.6 -1.8 10 9.8 14.5 ...
$ var.pob.96.01  : num  -1.8 -2.9 5.2 3.6 3.1 -2.4 11.5 11.4 5.3 2.1 ...
$ extension      : num  45 84 90 168 26 296 99 66 17 217 ...
$ paro2008       : num  3.9 3.9 7.8 4 5.5 7.3 4.3 2.3 7.2 7.6 ...
$ paro2007       : num  3.1 2.6 5.9 3.2 4.1 5.9 3.1 1.5 5.4 6.2 ...
$ paro2006       : num  4.3 3.1 6.2 3 3.8 5.9 2.6 1.6 4.8 4.9 ...
$ paro2005       : num  3.8 3.4 5.7 2.6 4.8 5.1 2.9 1.5 4.5 4.5 ...
$ paro2004       : num  1.8 1.1 3.1 2.4 3.1 3.7 2.2 1.1 2.8 3.4 ...
$ paro2003       : num  2.6 2.2 2.9 2.3 2.9 4 2 2.2 3.5 2.5 ...
$ paro2002       : num  2.6 1.8 2.5 2.5 2.9 4.1 1.3 2.1 3.4 2.8 ...
$ paro2001       : num  1.8 1.5 3 2.8 3.2 4 2.1 2.5 3.3 2.6 ...
$ paro2000       : num  3.2 2.3 2.7 2.7 3.2 3.9 2.2 2.3 3.8 2.6 ...
$ paro1999       : num  3 1.9 2.4 2.9 3.5 3.9 2.4 2.3 3.6 2.8 ...
$ paro1998       : num  3.1 3.2 2.6 3.3 3.2 4.8 2.2 3 4 2.9 ...
$ paro1997       : num  3 3.8 2.8 3.5 3.3 5.2 2.8 3.8 4.3 2.8 ...
$ paro1996       : num  4.4 2.1 2.8 4.3 4.7 5.5 2.9 3.4 3.7 2.7 ...
$ paro.hombres   : num  4.7 5.7 7.3 4.5 4.3 6.9 3.7 2.9 6 7.2 ...
$ paro.mujeres   : num  3.1 2.1 8.2 3.6 6.7 7.7 5 1.8 8.3 7.9 ...
$ paro.16.24     : num  4.8 4.5 10.2 3 5.2 7 4.5 3.3 6.3 10.8 ...
$ paro.25.49     : num  5.9 7.3 12.4 6.5 9.3 11.5 7.7 6 11.8 11.6 ...
$ paro.50        : num  3.2 1.9 4.2 3 3.8 5.7 2.3 1 4.9 4.7 ...
$ var.telef      : num  -5.4 -10.8 6.6 25.5 13.6 23.1 41.3 66.6 44.3 6.2 ...
$ adsl           : num  53 21 2766 1426 504 ...
$ var.motor      : num  60.3 54.9 42.4 34.6 46.5 ...
$ var.ofic.bancos: num  0 0 4 2 0 32 0 0 1 -1 ...
$ var.cooperativa: num  0 0 0 0 0 -3 0 0 0 -1 ...
$ var.industria  : num  16.7 8.3 -14.9 0.5 -8.3 17.5 2.2 16.7 -3.1 1.9 ...
$ var.mayorista  : num  50 0 0 16.1 -14.3 23.3 25 87.5 0 2.8 ...
$ var.minorista  : num  -10.3 -13.6 14.7 19.1 -18.5 16.4 5.4 -7.7 -25.4 10.9 ...
...
```r
datos.1$ine <- as.factor(as.integer(datos.1$ine / 1000))
datos.1$target <- as.factor(ifelse((datos.1$paro.mujeres / datos.1$paro.hombres - 1) >= 0.9, 1, 0))
# Eliminamos las variables que generan el target
datos.1 <- subset(datos.1, select = -c(paro.hombres, paro.mujeres))
table(datos.1$target)
summary(datos.1)
```
...
Con este código podemos ver cómo entran las variables en el modelo. El criterio de `AIC` nos da una medida de cuánto perdemos si eliminamos la variable del modelo. Mide el ajuste. A modo de ejemplo se podría asegurar que las `10` variables más significativas son:
