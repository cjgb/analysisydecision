...
Estas macros estarán guardadas en el archivo `Excel` con el que trabajemos y serán llamadas desde SAS, y pegaremos nuestros datos con formato europeo sin necesidad de trabajar el fichero SAS:
...
Nuestra tabla `Excel` ha mejorado mucho su aspecto. Un buen programa para comenzar a usar `DDE` con SAS. Podemos sofisticarlo todo lo que queramos y crear informes directamente con SAS. Saludos.