...
El siguiente truco de `Excel` es muy sencillo. Se trata de una consulta web que nos permite obtener el cambio de divisas a euro casi prácticamente *on-line*. La consulta se realiza sobre la web [www.finanzas.com](http://www.finanzas.com/), sitio que además quiero recomendar; desde él sigo la imparable caída de mis valores…

La consulta es la siguiente:

```vba
Sub cambio_divisas()
    ' Cambiamos la configuración regional temporalmente
    With Application
        .DecimalSeparator = "."
        .ThousandsSeparator = ","
    ...
    ' Restablecemos la configuración regional del sistema
    With Application
